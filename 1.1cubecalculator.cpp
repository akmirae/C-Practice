...
// The spelling, capitalization, and punctuation are all very specific, so copy and paste that text as your output! Our program should use doubles for storing our variables, and the result should be printed out on its own line, and nothing more.
